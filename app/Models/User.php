...
class User extends Authenticatable
{
    ...
    public function courses(){
        ...
        //* Fungsi yang berhubungan dengan akun yang berlangganan atau tidak 
    public function subscribe_transactions(){
        //* Alasan memakai hasmany karena user bisa berlangganan berkali-kali 
        return $this->hasMany(SubscribeTransaction::class);
    }

    //* Cek apakah masih aktif berlangganan atau tidak
