            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <div class="flex flex-row gap-x-10">
                    ...
                    <div class="flex flex-col gap-y-10">    
                        ...
                        <span class="w-fit text-sm font-bold py-2 px-3 rounded-full bg-green-500 text-white mr-2">
                            Active
                        </span>
                        @else
                        ...
                        <div>
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">{{\Carbon\Carbon::parse($subscribeTransaction->created_at)->format('D, j F Y')}}</h3>
                        </div>
                        <div>
