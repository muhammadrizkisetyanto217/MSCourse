...
<body class="text-black font-poppins pt-10 pb-[50px]">
    <div id="hero-section"
        ...
        <nav class="flex justify-between items-center pt-6 px-[50px]">
            ...
            <ul class="flex items-center gap-[30px] text-white">
                ...
                <li>
                    <a href="{{ route('front.home') }}" class="font-semibold">Stories</a>
                </li>
            </ul>
            ...
            @auth
                <div class="flex gap-[10px] items-center">
                    <div class="flex flex-col items-end justify-center">
                        <p class="font-semibold text-white">Ahlan, {{ Auth::user()->name }}</p>
        ...
        <div class="flex flex-col items-center gap-[30px]">
            <div class="w-fit flex items-center gap-3 p-2 pr-6 rounded-full bg-[#FFFFFF1F] border border-[#3477FF24]">
                <div class="w-[150px] h-[24px] flex shrink-0">
                    {{-- <img src="" class="object-contain" alt="icon"> --}}
                    <p class="font-semibold text-sm text-white">Bergabung bersama 20.000 peserta</p>
                </div>
            </div>
            <div class="flex flex-col gap-[10px]">
                <h1 class="font-semibold text-[80px] leading-[82px] text-center gradient-text-hero">Belajar Ilmu Syar'i
                    & Bahasa Arab.</h1>
                <p class="text-center text-xl leading-[36px] text-[#F5F8FA]">Menuntut ilmu bersama madinah salam.
                    Jadikan jalan menuntut ilmu sebagai jalan menuju <br>
    ...
    <section id="Top-Categories" class="max-w-[1200px] mx-auto flex flex-col p-[70px_50px] gap-[30px]">
        ...
        <div class="grid grid-cols-4 gap-[30px]">
            <a href="{{ route('front.category', 'diploma-arab') }}"
                ...
                <p class="font-bold text-lg">Diploma Arab</p>
            </a>
            <a href="{{ route('front.category', 'diploma-ilmi') }}""
                class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1-1.svg" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">Diploma Ilmi</p>
            </a>
            <a href="{{ route('front.category', 'diploma-quran') }}""
                class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1-2.svg" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">Diploma Qur'an</p>
            </a>
            <a href="{{ route('front.category', 'kursus') }}""
                class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1-3.svg" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg">Kursus</p>
            </a>
        </div>
    </section>
                            ...
                            <div class="flex flex-col px-4 gap-[10px]">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <p class="text-[#6D7786]">{{ $course->teacher->user->occupation }}r</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section id="Pricing" class="max-w-[1200px] mx-auto flex justify-between items-center p-[70px_100px]">
        <div class="relative">
            <div class="w-[355px] h-[488px]">
                <img src="assets/background/foto.jpeg" alt="icon">
            </div>
            <div
                ...
                <div
                    ...
                    <div class="test-card w-[300px] flex flex-col h-full bg-white rounded-xl gap-3 p-5">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 flex shrink-0 rounded-full overflow-hidden">
                                <img src="assets/background/foto.jpeg" class="w-full h-full object-cover"
                                    alt="photo">
                            </div>
